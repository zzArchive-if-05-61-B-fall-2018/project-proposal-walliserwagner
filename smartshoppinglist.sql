...
create table itemcontainer(itemcontainerid serial primary key not null, userid serial references users(userid), unit varchar not null, count integer not null, shoppinglistid serial references shoppinglist(shoppinglistid), category varchar not null, name varchar not null);
