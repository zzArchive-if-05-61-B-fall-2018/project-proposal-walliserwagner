...
create table "group"(groupid serial primary key not null, name varchar not null, changeset int);
...
create table itemcontainer(itemcontainerid serial primary key not null, userid serial references users(userid), unit varchar not null, count integer not null, shoppinglistid serial references shoppinglist(shoppinglistid), name varchar not null);
...
Create table changeset(ChangeID number, groupid serial, action varchar not null, data varchar not null);