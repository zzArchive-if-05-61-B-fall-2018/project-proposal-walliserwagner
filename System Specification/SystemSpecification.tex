...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Recipe_Tab.png}}{\caption{Recipe Tab}\label{case1}}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Recipe_Tab_Longclick.png}}{\caption{Long click on item}\label{zoom}}
           \end{floatrow}
        \end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Group_Tab.png}}{\caption{Group Tab}\label{case1}}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Group_Tab_Longclick.png}}{\caption{Long click on item}\label{zoom}}
           \end{floatrow}
        \end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Shoppinglist_Tab.png}}{\caption{Shoppinglist Tab}\label{case1}}
             \ffigbox{\includegraphics[scale=0.15]{Images/GUI_Shoppinglist_Tab_Longclick.png}}{\caption{Long click on item}\label{zoom}}
           \end{floatrow}
        \end{figure}
